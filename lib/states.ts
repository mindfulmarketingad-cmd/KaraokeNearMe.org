...
export const states: State[] = [
  ...
  },
  {
    ...
    capital: "Tallahassee",
    cities: [
      "Alachua", "Altamonte Springs", "Apalachicola", "Arcadia",
      "Atlantic Beach", "Auburndale", "Aventura", "Avon Park", "Bartow",
      "Belle Glade", "Belle Isle", "Belleview", "Boca Raton", "Bonita Springs",
      "Boynton Beach", "Bradenton", "Brandon", "Brooksville", "Cape Coral",
      "Casselberry", "Celebration", "Clearwater", "Clermont", "Clewiston",
      "Cocoa", "Cocoa Beach", "Coral Gables", "Coral Springs", "Crestview",
      "Cutler Bay", "Dade City", "Dania Beach", "Davie", "Daytona Beach",
      "DeBary", "DeFuniak Springs", "Deland", "Delray Beach", "Destin",
      "Dunedin", "Edgewater", "Eustis", "Fernandina Beach", "Flagler Beach",
      "Fort Lauderdale", "Fort Myers", "Fort Pierce", "Gainesville",
      "Green Cove Springs", "Hallandale Beach", "Hialeah", "Hollywood",
      "Homestead", "Inverness", "Jacksonville", "Jupiter", "Key West",
      "Kissimmee", "Lake City", "Lake Mary", "Lake Wales", "Lakeland",
      "Largo", "Leesburg", "Longwood", "Lynn Haven", "Maitland", "Margate",
      "Marianna", "Melbourne", "Miami", "Miami Beach", "Miramar", "Mount Dora",
      "Naples", "New Port Richey", "Niceville", "Ocala", "Ocoee", "Orlando",
      "Ormond Beach", "Oviedo", "Palm Bay", "Palm Coast", "Palm Beach Gardens",
      "Panama City", "Pensacola", "Plant City", "Pompano Beach", "Port Orange",
      "Port St. Lucie", "Punta Gorda", "Riverview", "Sanford", "Sarasota",
      "Sebring", "St. Augustine", "St. Petersburg", "Stuart", "Sunrise",
      "Tallahassee", "Tampa", "Tarpon Springs", "Titusville", "Venice",
      "Vero Beach", "West Palm Beach", "Winter Garden", "Winter Haven",
